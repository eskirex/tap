...
namespace tap\type;
    ...
    class TapIp extends AbstractTapVal {
        
        
        
        public function isIpv4() {
            return filter_var($this->val, FILTER_VALIDATE_IP, FILTER_FLAG_IPV4) !== false;
        }
        
        public function isIpv6() {
            return filter_var($this->val, FILTER_VALIDATE_IP, FILTER_FLAG_IPV6) !== false;
        }
        
        public function isPrivateSpace () {
            return ! (filter_var($this->val, FILTER_VALIDATE_IP, FILTER_FLAG_NO_PRIV_RANGE) !== false);
        }
